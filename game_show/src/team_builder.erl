...
person_tuple_list_test_() ->
	People = [{joe, male, 6.84}, {shelly, female, 5.8}, {bob, male, 11.7}, {jenny, female, 5.10}, {brad, male, 6.1}, {michal, male, 9.234}, {rebecca, female, 12.3}, {jessica, female, 4.7}], % TODO: Replace this with the list of tuples described in the previous comment
...
gender_list_test_()->
	Genders = [male, female], % TODO: Replace this with a list of genders including male, female, and other
